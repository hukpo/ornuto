...
export const DetailsStack: FC = () => {
  return <Stack.Navigator initialRouteName={ScreenName.TIPS_MAIN}>{DetailsStackScreens(Stack)}</Stack.Navigator>;
};

export const DetailsStackScreens: FC<ReturnType<typeof createNativeStackNavigator>> = ({ Screen, Group }) => {
  return (
